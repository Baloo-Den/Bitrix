...
class CBitrixCatalogImport1C extends CBitrixComponent
{
	...
	const XML_PICTURES_TABLE_NAME = 'b_xml_pictures_import_1c';
	const XML_STOCK_TABLE_NAME = 'b_xml_stock_import_1c';
	const XML_PRICE_TABLE_NAME = 'b_xml_price_import_1c';
	const XML_DISCOUNT_TABLE_NAME = 'b_xml_discount_import_1c';
	
	public function getTableName($typeExchange = "")
	  { $tableName = self::XML_TREE_TABLE_NAME;
	    if ($typeExchange=="pictures") $tableName = self::XML_PICTURES_TABLE_NAME;
	    else if ($typeExchange=="stock") $tableName = self::XML_STOCK_TABLE_NAME;
	    else if ($typeExchange=="price") $tableName = self::XML_PRICE_TABLE_NAME;
	    else if ($typeExchange=="discount") $tableName = self::XML_DISCOUNT_TABLE_NAME;
	    return $tableName;
	  }
