        ...
        <div class="form-login">
            ...
            <form name="form_auth" method="post" target="_top" action="<?= $arResult["AUTH_URL"] ?>">
                ...
                <div class="d-block text-center text-md-left my-4">
                    <input type="submit" name="Login" value="<?= GetMessage("AUTH_AUTHORIZE_ME") ?>" class="orange btn-login"/>
                ...
                if ($arParams["NOT_SHOW_LINKS"] != "Y") {
                    ...
                    <div class="d-block text-center">
                        <a href="<?= $arResult["AUTH_FORGOT_PASSWORD_URL"] ?>" rel="nofollow" class="orange"><?= GetMessage("AUTH_FORGOT_PASSWORD_ME") ?></a>
                        <br/>
