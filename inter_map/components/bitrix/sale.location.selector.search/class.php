...
//		\Adelfo\Utils\Log::addMessageToLog('CBitrixLocationSelectorSearchComponent_obtainDataLocation',[
//			'_POST' => $_POST,
//			'_GET' => $_GET,
//			'_SESSION' => $_SESSION,
//			'debug' => $debug,
...
//		\Adelfo\Utils\Log::addMessageToLog('CBitrixLocationSelectorSearchComponent_executeComponent',[
//			'_POST' => $_POST,
//			'_GET' => $_GET,
//			'_SESSION' => $_SESSION,
//			'debug' => $debug,
...
//		\Adelfo\Utils\Log::addMessageToLog('CBitrixLocationSelectorSearchComponent_getPathToNodes',[
//			'_POST' => $_POST,
//			'_GET' => $_GET,
//			'_SESSION' => $_SESSION,
//			'debug' => $debug,
//		], false, 'no_args');
	...
	protected static function processSearchGetAdditionalPathNodes(&$data)
	{
		...
		$debug['dataOut'] = $data;
//		\Adelfo\Utils\Log::addMessageToLog('CBitrixLocationSelectorSearchComponent_processSearchGetAdditionalPathNodes',[
//			'_POST' => $_POST,
//			'_GET' => $_GET,
//			'_SESSION' => $_SESSION,
//			'debug' => $debug,
