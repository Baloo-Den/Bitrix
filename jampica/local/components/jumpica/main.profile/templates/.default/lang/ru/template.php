...
$MESS["USER_CONTACT"] = "Контактное лицо: *";
$MESS["EMAIL"] = "E-Mail:";
...
$MESS["USER_PHONE"] = "Контактный номер: *";
$MESS["USER_FAX"] = "Факс:";
...
$MESS["main_profile_editing"] = "Изменить";
$MESS["main_profile_cancel"] = "Отмена";
$MESS["main_profile_save"] = "Сохранить";
$MESS["DELIVERY_ADDRESS"] = "Адрес доставки: *";
$MESS["POINT_CODE"] = "Код точки:";
$MESS["main_profile_uf_notification"] = "Оповещение о смене статуса заявки:";
$MESS["selected_division"] = "Дивизион";
$MESS["selected_region"] = "Регион";
$MESS["selected_city"] = "Город";
$MESS["dop_fio_add"] = "Введите контактное лицо";
$MESS["dop_tel_add"] = "+7(___)___-__-__";

$MESS["DOP_FIO"] = "Дополнительные контактные лица:";
$MESS["DOP_TEL"] = "Дополнительные контактные телефоны:";

$MESS["btn_add"] = "Добавить";
$MESS["btn_del"] = "Удалить";

$MESS["error_input"] = "Заполните";

$MESS["profil_welcome"] = "Добро пожаловать в профиль клиента!<br />Убедитесь что информация, представленная ниже, корректна.<br />Пожалуйста, заполните обязательные поля, отмеченные звездочной (*).";
